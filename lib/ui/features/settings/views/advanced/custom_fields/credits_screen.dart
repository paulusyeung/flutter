...
const kCustomFieldsCreditsSearchKeys = <String>[
  'credit_field',
  'label',
  'field_type',
  'single_line_text',
...
class CustomFieldsCreditsScreen extends StatelessWidget {
  const CustomFieldsCreditsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return SettingsFormShell(
      sections: [
        FormSection(
          title: context.tr('credit_field'),
          children: [
            for (var i = 1; i <= 4; i++)
              CustomFieldRow<CustomFieldsViewModel>(
                key: ValueKey('${access.companyId}:credit$i'),
                prefix: 'credit',
                slot: i,
