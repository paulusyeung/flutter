...
/// Settings > User Details — 7 tabs (Details, Password, Connect, Two Factor,
/// Accent Color, Notifications, Preferences) hosted by the generic
/// [TabbedSettingsShell]. Mirrors the layout of the React user-details page
/// minus the Custom Fields tab; user custom-field definitions live under
/// Settings > Custom Fields instead.
  ...
  Widget build(BuildContext context) {
    ...
    return TabbedSettingsShell<UserDetailsViewModel>(
      ...
      tabs: const [
        ...
        TabbedSettingsTab(
          slug: 'accent_color',
          labelKey: 'accent_color',
          body: UserDetailsAccentColorScreen(),
        ),
        TabbedSettingsTab(
          slug: 'notifications',
