      ...
      children: [
        TextField(
          ...
          decoration: billingFieldDecoration(
            context,
            label: context.tr('credit_number'),
              ...
              children: [
                MarkdownNotesField(
                  ...
                  onSaveAsDefault: (v) => saveBillingDocDefault(
                    ...
                    apply: (s, val) => s.copyWith(creditTerms: val),
                  ),
                ),
                MarkdownNotesField(
                  ...
                  onSaveAsDefault: (v) => saveBillingDocDefault(
                    ...
                    companyId: vm.companyId,
                    value: v,
                    fieldKey: 'credit_footer',
                    successKey: 'updated_default_footer',
                    apply: (s, val) => s.copyWith(creditFooter: val),
                  ),
                ),
                MarkdownNotesField(
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: context.tr('credit_number'),
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 16,
            child: BillingDocEditFab(
              heroTag: 'credit_picker_fab_mobile',
