...
mixin _$Quote {
 ...
 String get id; String get number; String get poNumber; Date? get date; Date? get dueDate; Date? get partialDueDate; QuoteStatus get statusId; String get clientId; String get vendorId; String get projectId; String get designId; String get assignedUserId; String get userId; String get locationId; String get subscriptionId; String get invoiceId; Decimal get amount; Decimal get balance; Decimal get taxAmount; Decimal get discount; Decimal get partial; bool get isAmountDiscount; Decimal get exchangeRate; String get taxName1; String get taxName2; String get taxName3; Decimal get taxRate1; Decimal get taxRate2; Decimal get taxRate3; bool get usesInclusiveTaxes; Decimal get customSurcharge1; Decimal get customSurcharge2; Decimal get customSurcharge3; Decimal get customSurcharge4; bool get customTaxes1; bool get customTaxes2; bool get customTaxes3; bool get customTaxes4; String get publicNotes; String get privateNotes; String get terms; String get footer; String get customValue1; String get customValue2; String get customValue3; String get customValue4; bool get isDeleted; DateTime get updatedAt; DateTime get createdAt; DateTime? get archivedAt; List<LineItem> get lineItems; List<Invitation> get invitations; List<Document> get documents; Map<String, dynamic>? get eInvoice;// Server-computed, read-only (display only — omitted from toApiJson).
 Date? get lastSentDate; Date? get nextSendDate; bool get isDirty;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,number,poNumber,date,dueDate,partialDueDate,statusId,clientId,vendorId,projectId,designId,assignedUserId,userId,locationId,subscriptionId,invoiceId,amount,balance,taxAmount,discount,partial,isAmountDiscount,exchangeRate,taxName1,taxName2,taxName3,taxRate1,taxRate2,taxRate3,usesInclusiveTaxes,customSurcharge1,customSurcharge2,customSurcharge3,customSurcharge4,customTaxes1,customTaxes2,customTaxes3,customTaxes4,publicNotes,privateNotes,terms,footer,customValue1,customValue2,customValue3,customValue4,isDeleted,updatedAt,createdAt,archivedAt,const DeepCollectionEquality().hash(lineItems),const DeepCollectionEquality().hash(invitations),const DeepCollectionEquality().hash(documents),const DeepCollectionEquality().hash(eInvoice),lastSentDate,nextSendDate,isDirty]);

@override
String toString() {
  return 'Quote(id: $id, number: $number, poNumber: $poNumber, date: $date, dueDate: $dueDate, partialDueDate: $partialDueDate, statusId: $statusId, clientId: $clientId, vendorId: $vendorId, projectId: $projectId, designId: $designId, assignedUserId: $assignedUserId, userId: $userId, locationId: $locationId, subscriptionId: $subscriptionId, invoiceId: $invoiceId, amount: $amount, balance: $balance, taxAmount: $taxAmount, discount: $discount, partial: $partial, isAmountDiscount: $isAmountDiscount, exchangeRate: $exchangeRate, taxName1: $taxName1, taxName2: $taxName2, taxName3: $taxName3, taxRate1: $taxRate1, taxRate2: $taxRate2, taxRate3: $taxRate3, usesInclusiveTaxes: $usesInclusiveTaxes, customSurcharge1: $customSurcharge1, customSurcharge2: $customSurcharge2, customSurcharge3: $customSurcharge3, customSurcharge4: $customSurcharge4, customTaxes1: $customTaxes1, customTaxes2: $customTaxes2, customTaxes3: $customTaxes3, customTaxes4: $customTaxes4, publicNotes: $publicNotes, privateNotes: $privateNotes, terms: $terms, footer: $footer, customValue1: $customValue1, customValue2: $customValue2, customValue3: $customValue3, customValue4: $customValue4, isDeleted: $isDeleted, updatedAt: $updatedAt, createdAt: $createdAt, archivedAt: $archivedAt, lineItems: $lineItems, invitations: $invitations, documents: $documents, eInvoice: $eInvoice, lastSentDate: $lastSentDate, nextSendDate: $nextSendDate, isDirty: $isDirty)';
}
...
as QuoteStatus,clientId: null == clientId ? _self.clientId : clientId // ignore: cast_nullable_to_non_nullable
...
as Map<String, dynamic>?,lastSentDate: freezed == lastSentDate ? _self.lastSentDate : lastSentDate // ignore: cast_nullable_to_non_nullable
as Date?,nextSendDate: freezed == nextSendDate ? _self.nextSendDate : nextSendDate // ignore: cast_nullable_to_non_nullable
as Date?,isDirty: null == isDirty ? _self.isDirty : isDirty // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@override final  QuoteStatus statusId;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,number,poNumber,date,dueDate,partialDueDate,statusId,clientId,vendorId,projectId,designId,assignedUserId,userId,locationId,subscriptionId,invoiceId,amount,balance,taxAmount,discount,partial,isAmountDiscount,exchangeRate,taxName1,taxName2,taxName3,taxRate1,taxRate2,taxRate3,usesInclusiveTaxes,customSurcharge1,customSurcharge2,customSurcharge3,customSurcharge4,customTaxes1,customTaxes2,customTaxes3,customTaxes4,publicNotes,privateNotes,terms,footer,customValue1,customValue2,customValue3,customValue4,isDeleted,updatedAt,createdAt,archivedAt,const DeepCollectionEquality().hash(_lineItems),const DeepCollectionEquality().hash(_invitations),const DeepCollectionEquality().hash(_documents),const DeepCollectionEquality().hash(_eInvoice),lastSentDate,nextSendDate,isDirty]);
