...
as List<String>,rawNotifications: null == rawNotifications ? _self.rawNotifications : rawNotifications // ignore: cast_nullable_to_non_nullable
...
class _User extends User {
  const _User({this.id = '', this.firstName = '', this.lastName = '', this.email = '', this.phone = '', this.signature = '', this.languageId = '', this.oauthProviderId = '', this.oauthUserToken = '', this.oauthUserRefreshToken = '', this.googleTwoFactorEnabled = false, this.verifiedPhoneNumber = false, this.hasPassword = false, this.userLoggedInNotification = false, this.customValue1 = '', this.customValue2 = '', this.customValue3 = '', this.customValue4 = '', this.lastLogin = 0, this.emailVerifiedAt = 0, this.createdAt = 0, this.updatedAt = 0, this.archivedAt = 0, this.isDeleted = false, this.isDirty = false, this.companyUser = const CompanyUser(), final  Map<String, dynamic> rawCompanyUserSettings = const <String, dynamic>{}, this.companyUserSettings = const CompanyUserSettings(), final  List<String> notificationsEmail = const <String>[], final  Map<String, dynamic> rawNotifications = const <String, dynamic>{}}): _rawCompanyUserSettings = rawCompanyUserSettings,_notificationsEmail = notificationsEmail,_rawNotifications = rawNotifications,super._();
...
@override@JsonKey() List<String> get notificationsEmail {
 ...
 final  Map<String, dynamic> _rawNotifications;
@override@JsonKey() Map<String, dynamic> get rawNotifications {
  if (_rawNotifications is EqualUnmodifiableMapView) return _rawNotifications;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_rawNotifications);
}
...
as List<String>,rawNotifications: null == rawNotifications ? _self._rawNotifications : rawNotifications // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>,
  ));
}
