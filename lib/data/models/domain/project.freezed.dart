...
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,assignedUserId,clientId,number,name,taskRate,dueDate,privateNotes,publicNotes,budgetedHours,currentHours,customValue1,customValue2,customValue3,customValue4,color,updatedAt,createdAt,archivedAt,isDeleted,const DeepCollectionEquality().hash(documents),isDirty]);

@override
String toString() {
  return 'Project(id: $id, userId: $userId, assignedUserId: $assignedUserId, clientId: $clientId, number: $number, name: $name, taskRate: $taskRate, dueDate: $dueDate, privateNotes: $privateNotes, publicNotes: $publicNotes, budgetedHours: $budgetedHours, currentHours: $currentHours, customValue1: $customValue1, customValue2: $customValue2, customValue3: $customValue3, customValue4: $customValue4, color: $color, updatedAt: $updatedAt, createdAt: $createdAt, archivedAt: $archivedAt, isDeleted: $isDeleted, documents: $documents, isDirty: $isDirty)';
}
...
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,assignedUserId,clientId,number,name,taskRate,dueDate,privateNotes,publicNotes,budgetedHours,currentHours,customValue1,customValue2,customValue3,customValue4,color,updatedAt,createdAt,archivedAt,isDeleted,const DeepCollectionEquality().hash(_documents),isDirty]);
