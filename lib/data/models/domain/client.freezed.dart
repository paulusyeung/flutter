...
mixin _$Client {
 ...
 String get id; String get name; String get displayName; String get number; String get idNumber; String get vatNumber; String get website; String get phone; String get address1; String get address2; String get city; String get state; String get postalCode; String get countryId; Decimal get balance; Decimal get paidToDate; Decimal get creditBalance; String get currencyId; String get languageId; String get paymentTerms; String get privateNotes; String get publicNotes; String get groupSettingsId; String get assignedUserId; DateTime get updatedAt; DateTime get createdAt; DateTime? get archivedAt; bool get isDeleted; String get customValue1; String get customValue2; String get customValue3; String get customValue4; List<Contact> get contacts; List<Location> get locations; List<Document> get documents;// Sparse per-client settings overrides. Mirrors the wire shape — keys
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,displayName,number,idNumber,vatNumber,website,phone,address1,address2,city,state,postalCode,countryId,balance,paidToDate,creditBalance,currencyId,languageId,paymentTerms,privateNotes,publicNotes,groupSettingsId,assignedUserId,updatedAt,createdAt,archivedAt,isDeleted,customValue1,customValue2,customValue3,customValue4,const DeepCollectionEquality().hash(_contacts),const DeepCollectionEquality().hash(_locations),const DeepCollectionEquality().hash(_documents),const DeepCollectionEquality().hash(_settings),isDirty]);
