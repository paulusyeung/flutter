...
@override
int get hashCode => Object.hashAll([runtimeType,id,productKey,notes,cost,price,quantity,maxQuantity,productImage,inStockQuantity,stockNotification,stockNotificationThreshold,taxName1,taxRate1,taxName2,taxRate2,taxName3,taxRate3,taxId,customValue1,customValue2,customValue3,customValue4,updatedAt,createdAt,archivedAt,isDeleted,const DeepCollectionEquality().hash(documents),isDirty]);

@override
String toString() {
  return 'Product(id: $id, productKey: $productKey, notes: $notes, cost: $cost, price: $price, quantity: $quantity, maxQuantity: $maxQuantity, productImage: $productImage, inStockQuantity: $inStockQuantity, stockNotification: $stockNotification, stockNotificationThreshold: $stockNotificationThreshold, taxName1: $taxName1, taxRate1: $taxRate1, taxName2: $taxName2, taxRate2: $taxRate2, taxName3: $taxName3, taxRate3: $taxRate3, taxId: $taxId, customValue1: $customValue1, customValue2: $customValue2, customValue3: $customValue3, customValue4: $customValue4, updatedAt: $updatedAt, createdAt: $createdAt, archivedAt: $archivedAt, isDeleted: $isDeleted, documents: $documents, isDirty: $isDirty)';
}
...
@override
int get hashCode => Object.hashAll([runtimeType,id,productKey,notes,cost,price,quantity,maxQuantity,productImage,inStockQuantity,stockNotification,stockNotificationThreshold,taxName1,taxRate1,taxName2,taxRate2,taxName3,taxRate3,taxId,customValue1,customValue2,customValue3,customValue4,updatedAt,createdAt,archivedAt,isDeleted,const DeepCollectionEquality().hash(_documents),isDirty]);
