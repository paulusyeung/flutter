...
mixin _$ClientApi {
 ...
 String get id; String get name;@JsonKey(name: 'display_name') String get displayName; String get number;@JsonKey(name: 'id_number') String get idNumber;@JsonKey(name: 'vat_number') String get vatNumber;// Server-assigned, read-only. Used to build the client-portal silent
// auto-login URL (`?silent=true&client_hash=…`). Always present on
// client GET/list responses.
@JsonKey(name: 'client_hash') String get clientHash; String get website;@JsonKey(name: 'phone') String get phone; String get address1; String get address2; String get city; String get state;@JsonKey(name: 'postal_code') String get postalCode;@JsonKey(name: 'country_id') String get countryId;@JsonKey(name: 'shipping_address1') String get shippingAddress1;@JsonKey(name: 'shipping_address2') String get shippingAddress2;@JsonKey(name: 'shipping_city') String get shippingCity;@JsonKey(name: 'shipping_state') String get shippingState;@JsonKey(name: 'shipping_postal_code') String get shippingPostalCode;@JsonKey(name: 'shipping_country_id') String get shippingCountryId;@JsonKey(name: 'balance') Object get balance;@JsonKey(name: 'paid_to_date') Object get paidToDate;@JsonKey(name: 'credit_balance') Object get creditBalance;@JsonKey(name: 'payment_balance') Object get paymentBalance;@JsonKey(name: 'currency_id') String get currencyId;@JsonKey(name: 'language_id') String get languageId;@JsonKey(name: 'payment_terms') String get paymentTerms;@JsonKey(name: 'private_notes') String get privateNotes;@JsonKey(name: 'public_notes') String get publicNotes;@JsonKey(name: 'custom_value1') String get customValue1;@JsonKey(name: 'custom_value2') String get customValue2;@JsonKey(name: 'custom_value3') String get customValue3;@JsonKey(name: 'custom_value4') String get customValue4;@JsonKey(name: 'group_settings_id') String get groupSettingsId;@JsonKey(name: 'assigned_user_id') String get assignedUserId;@JsonKey(name: 'industry_id') String get industryId;@JsonKey(name: 'size_id') String get sizeId;@JsonKey(name: 'classification') String get classification;@JsonKey(name: 'is_tax_exempt') bool get isTaxExempt;@JsonKey(name: 'has_valid_vat_number') bool get hasValidVatNumber;@JsonKey(name: 'routing_id') String get routingId;@JsonKey(name: 'user_id') String get userId;@JsonKey(name: 'last_login') int get lastLogin;@JsonKey(name: 'created_at') int get createdAt;@JsonKey(name: 'updated_at') int get updatedAt;@JsonKey(name: 'archived_at') int get archivedAt;@JsonKey(name: 'is_deleted') bool get isDeleted; List<ContactApi> get contacts;// Non-nullable (unlike `documents`) on purpose: the IN server embeds
...
// test fails loudly instead of silently wiping locations.
 List<LocationApi> get locations;// Saved payment methods (cards / bank accounts) stored at the gateway.
...
@JsonKey(name: 'gateway_tokens') List<GatewayTokenApi> get gatewayTokens;// Nullable on purpose: the IN list endpoint omits the `documents` field
...
/// Create a copy of ClientApi
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? displayName = null,Object? number = null,Object? idNumber = null,Object? vatNumber = null,Object? clientHash = null,Object? website = null,Object? phone = null,Object? address1 = null,Object? address2 = null,Object? city = null,Object? state = null,Object? postalCode = null,Object? countryId = null,Object? shippingAddress1 = null,Object? shippingAddress2 = null,Object? shippingCity = null,Object? shippingState = null,Object? shippingPostalCode = null,Object? shippingCountryId = null,Object? balance = null,Object? paidToDate = null,Object? creditBalance = null,Object? paymentBalance = null,Object? currencyId = null,Object? languageId = null,Object? paymentTerms = null,Object? privateNotes = null,Object? publicNotes = null,Object? customValue1 = null,Object? customValue2 = null,Object? customValue3 = null,Object? customValue4 = null,Object? groupSettingsId = null,Object? assignedUserId = null,Object? industryId = null,Object? sizeId = null,Object? classification = null,Object? isTaxExempt = null,Object? hasValidVatNumber = null,Object? routingId = null,Object? userId = null,Object? lastLogin = null,Object? createdAt = null,Object? updatedAt = null,Object? archivedAt = null,Object? isDeleted = null,Object? contacts = null,Object? locations = null,Object? gatewayTokens = null,Object? documents = freezed,Object? settings = freezed,}) {
...
as String,balance: null == balance ? _self.balance : balance ,paidToDate: null == paidToDate ? _self.paidToDate : paidToDate ,creditBalance: null == creditBalance ? _self.creditBalance : creditBalance ,paymentBalance: null == paymentBalance ? _self.paymentBalance : paymentBalance ,currencyId: null == currencyId ? _self.currencyId : currencyId // ignore: cast_nullable_to_non_nullable
...
as List<ContactApi>,locations: null == locations ? _self.locations : locations // ignore: cast_nullable_to_non_nullable
as List<LocationApi>,gatewayTokens: null == gatewayTokens ? _self.gatewayTokens : gatewayTokens // ignore: cast_nullable_to_non_nullable
as List<GatewayTokenApi>,documents: freezed == documents ? _self.documents : documents // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ClientApi() when $default != null:
return $default(_that.id,_that.name,_that.displayName,_that.number,_that.idNumber,_that.vatNumber,_that.clientHash,_that.website,_that.phone,_that.address1,_that.address2,_that.city,_that.state,_that.postalCode,_that.countryId,_that.shippingAddress1,_that.shippingAddress2,_that.shippingCity,_that.shippingState,_that.shippingPostalCode,_that.shippingCountryId,_that.balance,_that.paidToDate,_that.creditBalance,_that.paymentBalance,_that.currencyId,_that.languageId,_that.paymentTerms,_that.privateNotes,_that.publicNotes,_that.customValue1,_that.customValue2,_that.customValue3,_that.customValue4,_that.groupSettingsId,_that.assignedUserId,_that.industryId,_that.sizeId,_that.classification,_that.isTaxExempt,_that.hasValidVatNumber,_that.routingId,_that.userId,_that.lastLogin,_that.createdAt,_that.updatedAt,_that.archivedAt,_that.isDeleted,_that.contacts,_that.locations,_that.gatewayTokens,_that.documents,_that.settings);case _:
  return orElse();
...
class _ClientApi implements ClientApi {
  const _ClientApi({this.id = '', this.name = '', @JsonKey(name: 'display_name') this.displayName = '', this.number = '', @JsonKey(name: 'id_number') this.idNumber = '', @JsonKey(name: 'vat_number') this.vatNumber = '', @JsonKey(name: 'client_hash') this.clientHash = '', this.website = '', @JsonKey(name: 'phone') this.phone = '', this.address1 = '', this.address2 = '', this.city = '', this.state = '', @JsonKey(name: 'postal_code') this.postalCode = '', @JsonKey(name: 'country_id') this.countryId = '', @JsonKey(name: 'shipping_address1') this.shippingAddress1 = '', @JsonKey(name: 'shipping_address2') this.shippingAddress2 = '', @JsonKey(name: 'shipping_city') this.shippingCity = '', @JsonKey(name: 'shipping_state') this.shippingState = '', @JsonKey(name: 'shipping_postal_code') this.shippingPostalCode = '', @JsonKey(name: 'shipping_country_id') this.shippingCountryId = '', @JsonKey(name: 'balance') this.balance = '0', @JsonKey(name: 'paid_to_date') this.paidToDate = '0', @JsonKey(name: 'credit_balance') this.creditBalance = '0', @JsonKey(name: 'payment_balance') this.paymentBalance = '0', @JsonKey(name: 'currency_id') this.currencyId = '', @JsonKey(name: 'language_id') this.languageId = '', @JsonKey(name: 'payment_terms') this.paymentTerms = '', @JsonKey(name: 'private_notes') this.privateNotes = '', @JsonKey(name: 'public_notes') this.publicNotes = '', @JsonKey(name: 'custom_value1') this.customValue1 = '', @JsonKey(name: 'custom_value2') this.customValue2 = '', @JsonKey(name: 'custom_value3') this.customValue3 = '', @JsonKey(name: 'custom_value4') this.customValue4 = '', @JsonKey(name: 'group_settings_id') this.groupSettingsId = '', @JsonKey(name: 'assigned_user_id') this.assignedUserId = '', @JsonKey(name: 'industry_id') this.industryId = '', @JsonKey(name: 'size_id') this.sizeId = '', @JsonKey(name: 'classification') this.classification = '', @JsonKey(name: 'is_tax_exempt') this.isTaxExempt = false, @JsonKey(name: 'has_valid_vat_number') this.hasValidVatNumber = false, @JsonKey(name: 'routing_id') this.routingId = '', @JsonKey(name: 'user_id') this.userId = '', @JsonKey(name: 'last_login') this.lastLogin = 0, @JsonKey(name: 'created_at') this.createdAt = 0, @JsonKey(name: 'updated_at') this.updatedAt = 0, @JsonKey(name: 'archived_at') this.archivedAt = 0, @JsonKey(name: 'is_deleted') this.isDeleted = false, final  List<ContactApi> contacts = const <ContactApi>[], final  List<LocationApi> locations = const <LocationApi>[], @JsonKey(name: 'gateway_tokens') final  List<GatewayTokenApi> gatewayTokens = const <GatewayTokenApi>[], final  List<DocumentApi>? documents, @JsonKey(name: 'settings', includeIfNull: false) final  Map<String, dynamic>? settings}): _contacts = contacts,_locations = locations,_gatewayTokens = gatewayTokens,_documents = documents,_settings = settings;
...
// auto-login URL (`?silent=true&client_hash=…`). Always present on
// client GET/list responses.
@override@JsonKey(name: 'client_hash') final  String clientHash;
...
@override@JsonKey(name: 'payment_balance') final  Object paymentBalance;
...
@override@JsonKey(name: 'classification') final  String classification;
@override@JsonKey(name: 'is_tax_exempt') final  bool isTaxExempt;
@override@JsonKey(name: 'has_valid_vat_number') final  bool hasValidVatNumber;
...
// `[]` when none). Read-only — surfaced in the "Payment Methods" detail
// card and never written back as part of the client save payload.
 final  List<GatewayTokenApi> _gatewayTokens;
// Saved payment methods (cards / bank accounts) stored at the gateway.
// Present on client GET/list responses (probe-verified: top-level key,
// `[]` when none). Read-only — surfaced in the "Payment Methods" detail
// card and never written back as part of the client save payload.
@override@JsonKey(name: 'gateway_tokens') List<GatewayTokenApi> get gatewayTokens {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ClientApi&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.number, number) || other.number == number)&&(identical(other.idNumber, idNumber) || other.idNumber == idNumber)&&(identical(other.vatNumber, vatNumber) || other.vatNumber == vatNumber)&&(identical(other.clientHash, clientHash) || other.clientHash == clientHash)&&(identical(other.website, website) || other.website == website)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.address1, address1) || other.address1 == address1)&&(identical(other.address2, address2) || other.address2 == address2)&&(identical(other.city, city) || other.city == city)&&(identical(other.state, state) || other.state == state)&&(identical(other.postalCode, postalCode) || other.postalCode == postalCode)&&(identical(other.countryId, countryId) || other.countryId == countryId)&&(identical(other.shippingAddress1, shippingAddress1) || other.shippingAddress1 == shippingAddress1)&&(identical(other.shippingAddress2, shippingAddress2) || other.shippingAddress2 == shippingAddress2)&&(identical(other.shippingCity, shippingCity) || other.shippingCity == shippingCity)&&(identical(other.shippingState, shippingState) || other.shippingState == shippingState)&&(identical(other.shippingPostalCode, shippingPostalCode) || other.shippingPostalCode == shippingPostalCode)&&(identical(other.shippingCountryId, shippingCountryId) || other.shippingCountryId == shippingCountryId)&&const DeepCollectionEquality().equals(other.balance, balance)&&const DeepCollectionEquality().equals(other.paidToDate, paidToDate)&&const DeepCollectionEquality().equals(other.creditBalance, creditBalance)&&const DeepCollectionEquality().equals(other.paymentBalance, paymentBalance)&&(identical(other.currencyId, currencyId) || other.currencyId == currencyId)&&(identical(other.languageId, languageId) || other.languageId == languageId)&&(identical(other.paymentTerms, paymentTerms) || other.paymentTerms == paymentTerms)&&(identical(other.privateNotes, privateNotes) || other.privateNotes == privateNotes)&&(identical(other.publicNotes, publicNotes) || other.publicNotes == publicNotes)&&(identical(other.customValue1, customValue1) || other.customValue1 == customValue1)&&(identical(other.customValue2, customValue2) || other.customValue2 == customValue2)&&(identical(other.customValue3, customValue3) || other.customValue3 == customValue3)&&(identical(other.customValue4, customValue4) || other.customValue4 == customValue4)&&(identical(other.groupSettingsId, groupSettingsId) || other.groupSettingsId == groupSettingsId)&&(identical(other.assignedUserId, assignedUserId) || other.assignedUserId == assignedUserId)&&(identical(other.industryId, industryId) || other.industryId == industryId)&&(identical(other.sizeId, sizeId) || other.sizeId == sizeId)&&(identical(other.classification, classification) || other.classification == classification)&&(identical(other.isTaxExempt, isTaxExempt) || other.isTaxExempt == isTaxExempt)&&(identical(other.hasValidVatNumber, hasValidVatNumber) || other.hasValidVatNumber == hasValidVatNumber)&&(identical(other.routingId, routingId) || other.routingId == routingId)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.lastLogin, lastLogin) || other.lastLogin == lastLogin)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.archivedAt, archivedAt) || other.archivedAt == archivedAt)&&(identical(other.isDeleted, isDeleted) || other.isDeleted == isDeleted)&&const DeepCollectionEquality().equals(other._contacts, _contacts)&&const DeepCollectionEquality().equals(other._locations, _locations)&&const DeepCollectionEquality().equals(other._gatewayTokens, _gatewayTokens)&&const DeepCollectionEquality().equals(other._documents, _documents)&&const DeepCollectionEquality().equals(other._settings, _settings));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,displayName,number,idNumber,vatNumber,clientHash,website,phone,address1,address2,city,state,postalCode,countryId,shippingAddress1,shippingAddress2,shippingCity,shippingState,shippingPostalCode,shippingCountryId,const DeepCollectionEquality().hash(balance),const DeepCollectionEquality().hash(paidToDate),const DeepCollectionEquality().hash(creditBalance),const DeepCollectionEquality().hash(paymentBalance),currencyId,languageId,paymentTerms,privateNotes,publicNotes,customValue1,customValue2,customValue3,customValue4,groupSettingsId,assignedUserId,industryId,sizeId,classification,isTaxExempt,hasValidVatNumber,routingId,userId,lastLogin,createdAt,updatedAt,archivedAt,isDeleted,const DeepCollectionEquality().hash(_contacts),const DeepCollectionEquality().hash(_locations),const DeepCollectionEquality().hash(_gatewayTokens),const DeepCollectionEquality().hash(_documents),const DeepCollectionEquality().hash(_settings)]);
...
as List<ContactApi>,locations: null == locations ? _self._locations : locations // ignore: cast_nullable_to_non_nullable
as List<LocationApi>,gatewayTokens: null == gatewayTokens ? _self._gatewayTokens : gatewayTokens // ignore: cast_nullable_to_non_nullable
as List<GatewayTokenApi>,documents: freezed == documents ? _self._documents : documents // ignore: cast_nullable_to_non_nullable
