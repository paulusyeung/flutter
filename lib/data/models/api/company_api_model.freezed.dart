...
@JsonKey(name: 'use_comma_as_decimal_place') bool get useCommaAsDecimalPlace;@JsonKey(name: 'enabled_modules') int get enabledModules;@JsonKey(name: 'legal_entity_id') int get legalEntityId;// ── E-Invoice certificate ───────────────────────────────────────────
...
@JsonKey(name: 'has_e_invoice_certificate') bool get hasEInvoiceCertificate;@JsonKey(name: 'e_invoice_certificate_passphrase') String get eInvoiceCertificatePassphrase;@JsonKey(name: 'has_e_invoice_certificate_passphrase') bool get hasEInvoiceCertificatePassphrase;@JsonKey(name: 'subdomain') String get subdomain;@JsonKey(name: 'portal_domain') String get portalDomain;@JsonKey(name: 'portal_mode') String get portalMode;@JsonKey(name: 'client_can_register') bool get clientCanRegister;@JsonKey(name: 'client_registration_fields') List<ClientRegistrationFieldApi> get clientRegistrationFields;@JsonKey(name: 'custom_fields') Map<String, String> get customFields; Map<String, dynamic> get settings;@JsonKey(name: 'enable_applying_payments') bool get enableApplyingPayments;@JsonKey(name: 'convert_payment_currency') bool get convertPaymentCurrency;// ── Tax configuration ────────────────────────────────────────────────
...
@JsonKey(name: 'e_invoice', includeIfNull: false) Map<String, dynamic>? get eInvoice;// Per-surcharge "charge taxes" toggles paired with the four surcharge
