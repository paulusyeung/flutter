...
@JsonKey(name: 'task_statuses') List<TaskStatusApi> get taskStatuses;@JsonKey(name: 'company_gateways') List<CompanyGatewayApi> get companyGateways;@JsonKey(name: 'payment_terms') List<PaymentTermApi> get paymentTerms;@JsonKey(name: 'tax_rates') List<TaxRateApi> get taxRates;@JsonKey(name: 'expense_categories') List<ExpenseCategoryApi> get expenseCategories;// Subscriptions ("Payment Links") — same bundled-and-paginated
...
as List<ExpenseCategoryApi>,subscriptions: null == subscriptions ? _self.subscriptions : subscriptions // ignore: cast_nullable_to_non_nullable
...
as List<ExpenseCategoryApi>,subscriptions: null == subscriptions ? _self._subscriptions : subscriptions // ignore: cast_nullable_to_non_nullable
