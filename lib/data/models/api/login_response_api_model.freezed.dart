...
mixin _$CompanyEnvelopeApi {
 ...
 String get id;@JsonKey(name: 'display_name') String get displayName; String get name;@JsonKey(name: 'company_key') String get companyKey;// Top-level portal configuration. Edited by Settings → Client Portal;
...
@JsonKey(name: 'groups') List<GroupSettingApi> get groups;// Bank-transaction matching rules. Small settings-style list managed under
// Banking → Rules; `TransactionRuleRepository.applyBundle` upserts into
// the local `transaction_rules` table on every login/refresh.
@JsonKey(name: 'bank_transaction_rules') List<TransactionRuleApi> get bankTransactionRules;// Bank account integrations. Typically 1–10 rows per company.
// `BankAccountRepository.applyBundle` upserts into the local
// `bank_accounts` table on every login/refresh.
@JsonKey(name: 'bank_integrations') List<BankAccountApi> get bankIntegrations;// API webhooks. Small settings-style list; `WebhookRepository.applyBundle`
// upserts into the local `webhooks` table on every login/refresh.
@JsonKey(name: 'webhooks') List<WebhookApi> get webhooks;// API tokens. Small settings-style list; `TokenRepository.applyBundle`
...
@JsonKey(name: 'tokens_hashed') List<TokenApi> get tokensHashed;// Task schedulers ("Schedules") — bundled settings entity. The server
...
@JsonKey(name: 'task_schedulers') List<ScheduleApi> get taskSchedulers;// Subscriptions ("Payment Links") — same bundled-and-paginated
...
@JsonKey(name: 'subscriptions') List<SubscriptionApi> get subscriptions;// Invoice Design template list. The server ships the 11 built-in
...
// upserts into the local `group_settings` Drift table — the Settings →
// Group Settings list reads from Drift and skips the first paged fetch.
@override@JsonKey(name: 'groups') List<GroupSettingApi> get groups {
...
// Banking → Rules; `TransactionRuleRepository.applyBundle` upserts into
// the local `transaction_rules` table on every login/refresh.
@override@JsonKey(name: 'bank_transaction_rules') List<TransactionRuleApi> get bankTransactionRules {
...
// `BankAccountRepository.applyBundle` upserts into the local
// `bank_accounts` table on every login/refresh.
@override@JsonKey(name: 'bank_integrations') List<BankAccountApi> get bankIntegrations {
...
// API webhooks. Small settings-style list; `WebhookRepository.applyBundle`
// upserts into the local `webhooks` table on every login/refresh.
@override@JsonKey(name: 'webhooks') List<WebhookApi> get webhooks {
...
// server returns the `token` field MASKED in this array — the raw
// bearer secret only appears on the `POST /tokens` create response.
@override@JsonKey(name: 'tokens_hashed') List<TokenApi> get tokensHashed {
...
// `ScheduleRepository.applyBundle` upserts into the local `schedules`
// table on every login/refresh.
@override@JsonKey(name: 'task_schedulers') List<ScheduleApi> get taskSchedulers {
...
// pattern as expense_categories. `SubscriptionRepository.applyBundle`
// upserts into the `subscriptions` Drift table on every login/refresh.
@override@JsonKey(name: 'subscriptions') List<SubscriptionApi> get subscriptions {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,displayName,name,companyKey,subdomain,portalDomain,portalMode,const DeepCollectionEquality().hash(_clientRegistrationFields),const DeepCollectionEquality().hash(_customFields),sizeId,industryId,legalEntityId,enabledModules,const DeepCollectionEquality().hash(_settings),const DeepCollectionEquality().hash(_taskStatuses),const DeepCollectionEquality().hash(_companyGateways),const DeepCollectionEquality().hash(_paymentTerms),const DeepCollectionEquality().hash(_taxRates),const DeepCollectionEquality().hash(_expenseCategories),const DeepCollectionEquality().hash(_groups),const DeepCollectionEquality().hash(_bankTransactionRules),const DeepCollectionEquality().hash(_bankIntegrations),const DeepCollectionEquality().hash(_webhooks),const DeepCollectionEquality().hash(_tokensHashed),const DeepCollectionEquality().hash(_taskSchedulers),const DeepCollectionEquality().hash(_subscriptions),const DeepCollectionEquality().hash(_designs),enabledTaxRates,enabledItemTaxRates,enabledExpenseTaxRates,calculateTaxes,taxData,customSurchargeTaxes1,customSurchargeTaxes2,customSurchargeTaxes3,customSurchargeTaxes4,trackInventory,stockNotification,inventoryNotificationThreshold,enableProductDiscount,enableProductCost,enableProductQuantity,defaultQuantity,showProductDetails,fillProducts,updateProducts,convertProducts,convertRateToClient,stopOnUnpaidRecurring,useQuoteTermsOnConversion,googleAnalyticsKey,matomoId,matomoUrl,sessionTimeout,defaultPasswordTimeout,oauthPasswordRequired,isDisabled,markdownEnabled,markdownEmailEnabled,reportIncludeDrafts,reportIncludeDeleted,const DeepCollectionEquality().hash(_quickbooks)]);
...
/// Create a copy of CompanyEnvelopeApi
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? displayName = null,Object? name = null,Object? companyKey = null,Object? subdomain = null,Object? portalDomain = null,Object? portalMode = null,Object? clientRegistrationFields = null,Object? customFields = null,Object? sizeId = null,Object? industryId = null,Object? legalEntityId = null,Object? enabledModules = null,Object? settings = null,Object? taskStatuses = null,Object? companyGateways = null,Object? paymentTerms = null,Object? taxRates = null,Object? expenseCategories = null,Object? groups = null,Object? bankTransactionRules = null,Object? bankIntegrations = null,Object? webhooks = null,Object? tokensHashed = null,Object? taskSchedulers = null,Object? subscriptions = null,Object? designs = null,Object? enabledTaxRates = null,Object? enabledItemTaxRates = null,Object? enabledExpenseTaxRates = null,Object? calculateTaxes = null,Object? taxData = freezed,Object? customSurchargeTaxes1 = null,Object? customSurchargeTaxes2 = null,Object? customSurchargeTaxes3 = null,Object? customSurchargeTaxes4 = null,Object? trackInventory = null,Object? stockNotification = null,Object? inventoryNotificationThreshold = null,Object? enableProductDiscount = null,Object? enableProductCost = null,Object? enableProductQuantity = null,Object? defaultQuantity = null,Object? showProductDetails = null,Object? fillProducts = null,Object? updateProducts = null,Object? convertProducts = null,Object? convertRateToClient = null,Object? stopOnUnpaidRecurring = null,Object? useQuoteTermsOnConversion = null,Object? googleAnalyticsKey = null,Object? matomoId = null,Object? matomoUrl = null,Object? sessionTimeout = null,Object? defaultPasswordTimeout = null,Object? oauthPasswordRequired = null,Object? isDisabled = null,Object? markdownEnabled = null,Object? markdownEmailEnabled = null,Object? reportIncludeDrafts = null,Object? reportIncludeDeleted = null,Object? quickbooks = freezed,}) {
...
mixin _$AccountEnvelopeApi {
 ...
 String get id;@JsonKey(name: 'default_company_id') String get defaultCompanyId; String get plan;@JsonKey(name: 'plan_expires') String get planExpires;@JsonKey(name: 'trial_started') String get trialStarted;@JsonKey(name: 'trial_plan') String get trialPlan;@JsonKey(name: 'num_trial_days') int get numTrialDays;@JsonKey(name: 'hosted_client_count') int get hostedClientCount;@JsonKey(name: 'hosted_company_count') int get hostedCompanyCount;@JsonKey(name: 'e_invoicing_token') String get eInvoicingToken;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'default_company_id') String defaultCompanyId, String plan,@JsonKey(name: 'plan_expires') String planExpires,@JsonKey(name: 'trial_started') String trialStarted,@JsonKey(name: 'trial_plan') String trialPlan,@JsonKey(name: 'num_trial_days') int numTrialDays,@JsonKey(name: 'hosted_client_count') int hostedClientCount,@JsonKey(name: 'hosted_company_count') int hostedCompanyCount,@JsonKey(name: 'e_invoicing_token') String eInvoicingToken
});
...
/// Create a copy of AccountEnvelopeApi
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? defaultCompanyId = null,Object? plan = null,Object? planExpires = null,Object? trialStarted = null,Object? trialPlan = null,Object? numTrialDays = null,Object? hostedClientCount = null,Object? hostedCompanyCount = null,Object? eInvoicingToken = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'default_company_id')  String defaultCompanyId,  String plan, @JsonKey(name: 'plan_expires')  String planExpires, @JsonKey(name: 'trial_started')  String trialStarted, @JsonKey(name: 'trial_plan')  String trialPlan, @JsonKey(name: 'num_trial_days')  int numTrialDays, @JsonKey(name: 'hosted_client_count')  int hostedClientCount, @JsonKey(name: 'hosted_company_count')  int hostedCompanyCount, @JsonKey(name: 'e_invoicing_token')  String eInvoicingToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountEnvelopeApi() when $default != null:
return $default(_that.id,_that.defaultCompanyId,_that.plan,_that.planExpires,_that.trialStarted,_that.trialPlan,_that.numTrialDays,_that.hostedClientCount,_that.hostedCompanyCount,_that.eInvoicingToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'default_company_id')  String defaultCompanyId,  String plan, @JsonKey(name: 'plan_expires')  String planExpires, @JsonKey(name: 'trial_started')  String trialStarted, @JsonKey(name: 'trial_plan')  String trialPlan, @JsonKey(name: 'num_trial_days')  int numTrialDays, @JsonKey(name: 'hosted_client_count')  int hostedClientCount, @JsonKey(name: 'hosted_company_count')  int hostedCompanyCount, @JsonKey(name: 'e_invoicing_token')  String eInvoicingToken)  $default,) {final _that = this;
switch (_that) {
case _AccountEnvelopeApi():
return $default(_that.id,_that.defaultCompanyId,_that.plan,_that.planExpires,_that.trialStarted,_that.trialPlan,_that.numTrialDays,_that.hostedClientCount,_that.hostedCompanyCount,_that.eInvoicingToken);case _:
  throw StateError('Unexpected subclass');
...
/// Create a copy of AccountEnvelopeApi
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? defaultCompanyId = null,Object? plan = null,Object? planExpires = null,Object? trialStarted = null,Object? trialPlan = null,Object? numTrialDays = null,Object? hostedClientCount = null,Object? hostedCompanyCount = null,Object? eInvoicingToken = null,}) {
