...
@JsonKey(name: 'task_statuses') List<TaskStatusApi> get taskStatuses;@JsonKey(name: 'company_gateways') List<CompanyGatewayApi> get companyGateways;@JsonKey(name: 'payment_terms') List<PaymentTermApi> get paymentTerms;@JsonKey(name: 'tax_rates') List<TaxRateApi> get taxRates;@JsonKey(name: 'expense_categories') List<ExpenseCategoryApi> get expenseCategories;// Task schedulers ("Schedules") — bundled settings entity. The server
...
as List<ExpenseCategoryApi>,taskSchedulers: null == taskSchedulers ? _self.taskSchedulers : taskSchedulers // ignore: cast_nullable_to_non_nullable
...
as List<ExpenseCategoryApi>,taskSchedulers: null == taskSchedulers ? _self._taskSchedulers : taskSchedulers // ignore: cast_nullable_to_non_nullable
