...
_PurchaseOrderApi _$PurchaseOrderApiFromJson(Map<String, dynamic> json) =>
    _PurchaseOrderApi(
...
Map<String, dynamic> _$PurchaseOrderApiToJson(_PurchaseOrderApi instance) =>
    <String, dynamic>{
      'id': instance.id,
...
Map<String, dynamic> _$PurchaseOrderListApiToJson(
  _PurchaseOrderListApi instance,
) => <String, dynamic>{'data': instance.data};

_PurchaseOrderItemApi _$PurchaseOrderItemApiFromJson(
  Map<String, dynamic> json,
) => _PurchaseOrderItemApi(
  data: PurchaseOrderApi.fromJson(json['data'] as Map<String, dynamic>),
);

Map<String, dynamic> _$PurchaseOrderItemApiToJson(
  _PurchaseOrderItemApi instance,
) => <String, dynamic>{'data': instance.data};
