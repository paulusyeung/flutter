...
_CreditApi _$CreditApiFromJson(Map<String, dynamic> json) => _CreditApi(
...
Map<String, dynamic> _$CreditApiToJson(_CreditApi instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_CreditItemApi _$CreditItemApiFromJson(Map<String, dynamic> json) =>
    _CreditItemApi(
      data: CreditApi.fromJson(json['data'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CreditItemApiToJson(_CreditItemApi instance) =>
    <String, dynamic>{'data': instance.data};
