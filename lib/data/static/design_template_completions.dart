...
const List<String> kTwigOperatorKeywords = [
  'and', 'or', 'not', 'in', 'is', 'defined', 'empty',
];
...
final TwigCatalog kTwigCatalog = TwigCatalog(
  ...
  filters: const [
    ...
    'filter', 'length', 'merge',
    'format_currency', 'format_number', 'format_percent_number',
    'map', 'join', 'first', 'date', 'sum', 'nl2br', 'reduce',
  ],
...
const EntitySchema _invoiceSchema = EntitySchema(
  fields: [
    'amount', 'balance', 'status_id', 'status',
    'amount_raw', 'balance_raw',
    'number', 'discount', 'po_number',
    'date', 'last_sent_date', 'next_send_date', 'due_date',
    'terms', 'public_notes', 'private_notes',
    'uses_inclusive_taxes',
    'tax_name1', 'tax_rate1', 'tax_name2', 'tax_rate2', 'tax_name3', 'tax_rate3',
    'total_taxes', 'total_taxes_raw',
    'is_amount_discount', 'footer', 'partial', 'partial_due_date',
    'custom_value1', 'custom_value2', 'custom_value3', 'custom_value4',
    'custom_surcharge1', 'custom_surcharge2', 'custom_surcharge3', 'custom_surcharge4',
    'exchange_rate',
    'custom_surcharge_tax1', 'custom_surcharge_tax2',
    'custom_surcharge_tax3', 'custom_surcharge_tax4',
    'reminder1_sent', 'reminder2_sent', 'reminder3_sent', 'reminder_last_sent',
    'paid_to_date', 'auto_bill_enabled',
    'actual_delivery_date', 'invoice_period',
    'valid_until', 'is_deleted', 'has_tasks', 'has_expenses', 'currency_id',
  ],
  objects: {
    'project': 'project',
    'client': 'client',
...
const EntitySchema _lineItemSchema = EntitySchema(
  fields: [
    'quantity', 'cost', 'product_key', 'notes', 'discount',
    'is_amount_discount',
    'tax_name1', 'tax_rate1', 'tax_name2', 'tax_rate2', 'tax_name3', 'tax_rate3',
    'sort_id', 'line_total', 'gross_line_total',
    'custom_value1', 'custom_value2', 'custom_value3', 'custom_value4',
    'type_id', 'product_cost', 'tax_amount', 'date',
    'tax_id', 'task_id', 'expense_id', '_id',
    'cost_raw', 'discount_raw', 'line_total_raw', 'gross_line_total_raw',
    'tax_amount_raw', 'product_cost_raw', 'net_cost', 'net_cost_raw',
  ],
  objects: {'task': 'task'},
);
...
const EntitySchema _taskSchema = EntitySchema(
  fields: [
    'number', 'description', 'duration', 'rate', 'rate_raw',
...
const EntitySchema _paymentableSchema = EntitySchema(
  fields: [
    'amount_raw', 'refunded_raw', 'net_raw',
    'amount', 'refunded', 'net',
    'is_credit', 'date', 'created_at', 'updated_at', 'timestamp',
  ],
...
const EntitySchema _clientSchema = EntitySchema(
  fields: [
    'name', 'number', 'id_number',
    'invoice_term_days', 'quote_term_days',
    'balance', 'payment_balance', 'credit_balance',
    'vat_number', 'currency', 'locale',
    'address1', 'address2', 'city', 'state', 'postal_code', 'country_id',
    'group', 'phone', 'address', 'shipping_address',
    'custom_value1', 'custom_value2', 'custom_value3', 'custom_value4',
  ],
...
const EntitySchema _locationSchema = EntitySchema(
  fields: [
    'location_name', 'address', 'address1', 'address2',
...
const EntitySchema _projectSchema = EntitySchema(
  fields: [
    'id', 'name', 'number',
    'created_at', 'updated_at',
    'task_rate', 'task_rate_raw',
    'due_date', 'private_notes', 'public_notes',
    'budgeted_hours',
    'custom_value1', 'custom_value2', 'custom_value3', 'custom_value4',
    'color', 'current_hours',
  ],
...
const EntitySchema _expenseSchema = EntitySchema(
  fields: [
    'number', 'category', 'amount', 'amount_raw',
    'date', 'private_notes', 'public_notes', 'exchange_rate',
    'tax_name1', 'tax_rate1', 'tax_name2', 'tax_rate2', 'tax_name3', 'tax_rate3',
    'tax_amount1', 'tax_amount2', 'tax_amount3',
    'payment_date', 'transaction_reference',
    'custom_value1', 'custom_value2', 'custom_value3', 'custom_value4',
    'calculate_tax_by_amount', 'uses_inclusive_taxes',
  ],
  objects: {
    'client': 'client',
    'vendor': 'vendor',
...
const EntitySchema _vendorSchema = EntitySchema(
  fields: [
    'name', 'phone', 'website', 'number',
    'id_number', 'vat_number', 'currency',
    'custom_value1', 'custom_value2', 'custom_value3', 'custom_value4',
    'address', 'shipping_address', 'locale',
  ],
);
...
const EntitySchema _companySchema = EntitySchema(
  fields: [
    ...
    'country', 'country_2',
    'city_state_postal', 'postal_city_state', 'postal_city',
    'phone', 'email', 'vat_number', 'id_number', 'website',
    'payment_terms', 'valid_until',
    'custom1', 'custom2', 'custom3', 'custom4',
  ],
);

const EntitySchema _taxMapSchema = EntitySchema(
  fields: ['name', 'total'],
);
