...
void main() {
  group('DesignApi ↔ Design round-trip', () {
    ...
    test('WYSIWYG: blocks + documentSettings round-trip preserves every field', () {
      ...
      expect(domain.template.blocks[0].properties['source'], r'$company.logo');
      ...
      final wire = jsonDecode(jsonEncode(domain.toApiJson(preserveTempId: true)))
    ...
    test(
      'DesignTemplate.toApi() injects rowAlign/rowWidth/colStart/colSpan '
      ...
      () {
        ...
        final wire = jsonDecode(jsonEncode(template.toApi().toJson()))
            as Map<String, dynamic>;
    ...
    test('design without blocks/documentSettings stays minimal on the wire', () {
      ...
      final wire = jsonDecode(jsonEncode(domain.toApi().toJson()))
          as Map<String, dynamic>;
      expect(
