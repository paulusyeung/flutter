...
void main() {
  ...
  test('reactivateInvitationEmail enqueues a reactivate_email row keyed to the '
      'doc with the message_id payload — no Drift write', () async {
    ...
    final invoiceRow = await db.invoiceDao
        .watchById(companyId: 'co', id: 'inv1')
        .first;
